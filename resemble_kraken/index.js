...
async function executeTest(){
	...
	for(dir of scenarios){
		...
		let ScenFiles= getFiles(`../kraken/reports/version3/${config.scenarios[i]}.feature/screenshots`);
		var j=0;
		for(file of ScenFiles){
			const data = await compareImages(
				fs.readFileSync(`../kraken/reports/version3/${config.scenarios[i]}.feature/screenshots/${config.scenarios[i]}.feature-${j}.png`),
				fs.readFileSync(`../kraken/reports/version4/${config.scenarios[i]}.feature/screenshots/${config.scenarios[i]}.feature-${j}.png`),
				options
			);
			resultInfo[file] = {
	...
	<div class="row" id="step_${step}">
		<div class="col-md-4">
			  <div class="imgcontainer">
				...
				<img class="img2" src="../../../kraken/reports/version3/${config.scenarios[config.scenarios.indexOf(b)]}.feature/screenshots/${config.scenarios[config.scenarios.indexOf(b)]}.feature-${step}.png" id="refImage" label="Reference">
			  </div>		
		</div>
		<div class="col-md-4">
			  <div class="imgcontainer">
				<span class="imgname">Ghost version 4</span>
				<img class="img2" src="../../../kraken/reports/version4/${config.scenarios[config.scenarios.indexOf(b)]}.feature/screenshots/${config.scenarios[config.scenarios.indexOf(b)]}.feature-${step}.png" id="refImage" label="Reference">
			  </div>
		</div>
		<div class="col-md-4">
			  <div class="imgcontainer">
