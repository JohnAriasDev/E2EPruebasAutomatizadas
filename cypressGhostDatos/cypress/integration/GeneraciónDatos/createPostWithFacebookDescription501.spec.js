...
describe("create a post with metadata", () => {
  ...
  it("create a post with metadata", () => {
    ...
    postSelector.getFacebookTitleInput().type(faker.lorem.paragraphs(5).substring(0, 299));
    postSelector.getFacebookDescriptionInput().type(faker.lorem.paragraphs(5).substring(0, 501));
    postSelector.getFacebookTitleInput().click();
  //@Then    
  postSelector.getFacebookErrorDescriptionInput().should('to.contain', 'Facebook Description cannot be longer than 500 characters.');
