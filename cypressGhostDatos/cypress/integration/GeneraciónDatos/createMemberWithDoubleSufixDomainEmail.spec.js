...
describe("create member with double sufix domain email", () => {
    let data;
    const myOracleName = faker.name.firstName();
    const myOracle = faker.internet.email() + faker.internet.domainName();
  ...
  //@When
  it("Create a member with double sufix domain email", () => {
