...
describe("create a post with metadata", () => {
  ...
  it("create a post with metadata", () => {
    ...
    postSelector.getFacebookDescriptionInput().type(faker.lorem.paragraphs(5).substring(0, 500));
    postSelector.getFacebookTitleInput().click();
  //@Then    
  postSelector.getFacebookErrorDescriptionInput().should('not.to.be.visible');
