...
describe("create a post with metadata", () => {
  ...
  it("create a post with metadata", () => {
    ...
    postSelector.getTwitterTitleInput().type(data.datos.title301);
    postSelector.getTwitterDescriptionInput().type(faker.lorem.paragraphs(5).substring(0, 250));
  //@Then    
  postSelector.getTwitterErrorTitleInput().should('to.contain', 'Twitter Title cannot be longer than 300 characters.');
